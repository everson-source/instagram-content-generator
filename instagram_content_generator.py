...
"""
Instagram Content Generator para Prof. Everson - VERSÃO SIMPLIFICADA
Gera imagens + copy automático e salva em Google Sheets como base64
"""
...
def atualizar_google_sheets(conteudo, img_base64, sheet_id, credentials):
    """Atualiza Google Sheets com novo conteúdo + imagem em base64"""
...
def main():
    ...
    try:
        ...
        atualizar_google_sheets(conteudo, img_base64, sheet_id, credentials)
